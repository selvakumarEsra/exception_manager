...
var BarChart = (0, _AnimationDecorator2.default)(_class = (0, _PureRender2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(BarChart, [{
    ...
    key: 'getBarPosition',
    value: function getBarPosition(bandSize, sizeList, maxBarSize) {
    ...
    value: function getSizeList(stackGroups) {
      ...
      var globalSize = _props3.barSize;
      ...
      for (var i = 0, len = numericAxisIds.length; i < len; i++) {
        ...
        for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
          ...
          if (barItems && barItems.length) {
            ...
            var dataKey = _barItems$0$props.dataKey;
            var selfSize = _barItems$0$props.barSize;
    ...
    value: function renderItems(items, xAxisMap, yAxisMap, offset, stackGroups) {
      ...
      var globalMax = _props5.maxBarSize;
      ...
      return items.map(function (child, i) {
        ...
        var selfMax = _child$props.maxBarSize;
        ...
        var maxBarSize = (0, _isNil3.default)(selfMax) ? globalMax : selfMax;
        var barPosition = barPositionMap[cateAxisId] || _this2.getBarPosition(bandSize, sizeList[cateAxisId], maxBarSize);
